...
function reveal() {
    ...
    document.getElementById("card-container").style.width = "960px";
    document.getElementById("card-container").style.height = "480px";
    ...
    // document.querySelector('#card-container').appendChild(thiep);
}
